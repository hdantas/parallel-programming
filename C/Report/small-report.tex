...
\newcommand{\longtitle}[0]{Assignment C - List Ranking (Pointer Jumping)} %For document title and cover
\newcommand{\shorttitle}[0]{Assignment C - List Ranking (Pointer Jumping)} %For bookmark name, no special characters
