...
\newcommand{\longtitle}[0]{Assignment A - Prefix/suffix minima} %For document title and cover
\newcommand{\shorttitle}[0]{Assignment A - Prefix/suffix minima} %For bookmark name, no special characters
